...
public class BeerControllerTest {
    ...
    void whenGETIsCalledWithoutRegisteredNameThenNotFoundStatusIsReturned() throws Exception {
        ...
        //when
        when(beerService.findByName(beerDTO.getName())).thenThrow(BeerObjectNotFoundException.class);
    ...
    void whenDELETEIsCalledWithInvalidIdThenNotFoundStatusIsReturned() throws Exception {
        //when
        doThrow(BeerObjectNotFoundException.class).when(beerService).deleteById(INVALID_BEER_ID);
    ...
    void whenPATCHIsCalledWithInvalidBeerIdToIncrementThenNotFoundStatusIsReturned() throws Exception {
        ...
        when(beerService.increment(INVALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerObjectNotFoundException.class);
    ...
    void whenPATCHIsCalledWithInvalidBeerIdToDecrementThenNotFoundStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(INVALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerObjectNotFoundException.class);
